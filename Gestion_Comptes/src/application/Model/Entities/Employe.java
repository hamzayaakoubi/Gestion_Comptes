...
public class Employe extends Personne {
	...
	public Employe(int id,  String numeroEmploye,String nom, String prenom, String adresse, String dN, String email, String numeroTel ) {
		super(id, nom, prenom, adresse, dN, email, numeroTel);
		this.NumeroEmploye =numeroEmploye ;
		ArrayList<Reclamation> Reclamation= new ArrayList<Reclamation>();
	}
	
	public Employe(String nom, String prenom, String adresse, String dN, String email, String numeroTel,String numeroEmploye) {
		super(nom, prenom, adresse, dN, email, numeroTel);
		this.NumeroEmploye =numeroEmploye ;
	}
